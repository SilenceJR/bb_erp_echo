...
test('嵌套建档在同一载体内切换步骤，不创建第二条右轨', () => {
  ...
  assert.doesNotMatch(moduleForm, /WorkorderTemporaryProductStep|temporaryProductDialogVisible/)
  assert.match(moduleForm, /WorkorderProductField v-if="field\.kind === 'workorder-product'"/)
