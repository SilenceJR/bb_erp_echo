...
const {loading, listError, statisticsData, formatDate, statisticsCards, inventoryItemTypeLabel, formatQuantity, formatMoney, departmentName, departmentCompletionRate, stockState, compactTrendItems, trendNameLabel, trendBarPercentage} = useWorkspaceContext()
