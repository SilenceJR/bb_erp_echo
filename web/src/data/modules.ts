...
export const modules: ModuleItem[] = [
  ...
  { key: 'updates', title: '版本与更新', group: 'system', path: '/api/v1/system/updates/status', readPermission: 'system:updates:read', writePermission: 'system:updates:write', status: 'available', description: '查看服务端与桌面客户端版本、本机发布清单及局域网完整包状态。' },
