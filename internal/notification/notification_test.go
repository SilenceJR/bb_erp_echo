...
func TestDescriptorForMutationPathsAndOperations(t *testing.T) {
	cases := []struct {
		...
		{path: "/api/v1/products", ok: true, module: "warehouses", entityType: "product", operation: OperationCreate},
...
func TestAllProtectedBusinessWriteRoutesHaveNotificationDescriptors(t *testing.T) {
	routes := []struct {
		...
		{http.MethodPost, "/api/v1/warehouse/items", false},
		...
		{http.MethodPost, "/api/v1/warehouse/items/:itemType/:itemID/movements", false},
		{http.MethodPost, "/api/v1/materials", false},
		{http.MethodPost, "/api/v1/products", false},
		{http.MethodPost, "/api/v1/workorder", false},
		{http.MethodPost, "/api/v1/workorder/products", false},
