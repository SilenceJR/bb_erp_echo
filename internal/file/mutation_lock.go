...
var productAssetMutation sync.Mutex
...
// LockProductAssetMutation serializes product deletion/full import with product image writes.
func LockProductAssetMutation() func() {
	productAssetMutation.Lock()
	return productAssetMutation.Unlock
}
